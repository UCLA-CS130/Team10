...
TEST_CLASSES=config_parser.cpp connection.cpp connection_manager.cpp mime_types.cpp response.cpp echo_handler.cpp server.cpp request.cpp not_found_handler.cpp

CLASSES=config_parser.o connection.o connection_manager.o server_config.o main.o mime_types.o response.o echo_handler.o server.o request.o not_found_handler.o
