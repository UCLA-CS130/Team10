...
TEST_CLASSES=config_parser.cpp connection.cpp connection_manager.cpp mime_types.cpp reply.cpp request_handler_echo.cpp request_parser.cpp server.cpp

CLASSES=config_parser.o connection.o connection_manager.o main.o mime_types.o reply.o request_handler_echo.o request_handler_file.o request_parser.o server.o
